...
namespace bkw.auto.provider
{
    /// <summary>
    /// in the real world we will have a data driven options provider, but this will suffice for this demo project
    /// and is instrumental in running consistent unit tests
    /// </summary>
    public class CompiledVehicleOptionsProvider: IVehicleOptionsProvider
    {
        public IEnumerable<IVehicleOption> GetVehicleOptions(VehicleKind kind)
        {
            IVehicleOptionsProvider p1 = new DriveTrainOptionsProvider();
    ...
    class DriveTrainOptionsProvider : IVehicleOptionsProvider
    {
